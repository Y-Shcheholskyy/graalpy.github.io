...
Follow the steps below to debug an example application.

1. [Create an example application](getting-started/demo-application/).

2. Insert a `breakpoint()` function at line 13 in the file named _currency\_exchange.py_ (before the `for` loop):
